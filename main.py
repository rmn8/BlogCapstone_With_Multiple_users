...
def register():
    ...
    if form.validate_on_submit():
        ...
        if(user):
            flash("The user exists. Please try a different username")
        else:
            new_reg = User(
                name=form.name.data,
    ...
    if form.validate_on_submit():
        ...
        if (user):
            if check_password_hash(user.password, pw):
                ...
                flash("The Password does not exist. Please try again later")
        else:
            flash("The Username does not exist. Please try again later")
...
def show_post(post_id):
    ...
    comments = CommentTable.query.all()
